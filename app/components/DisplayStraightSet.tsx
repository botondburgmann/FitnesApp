    ...
    : 
        ...
        ?   <View style={styles.gridContainer}>
                <View style={styles.gridItem}>
                    ...
                    {exercise.repsLeft.map((rep, index) => 
                        ...
                        ? 
                         <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsLeft[index]+exercise.repsRight[index]))}>
                        ...
                        ? 
                        <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsLeft[index]* exercise.timesLeft[index] + exercise.repsRight[index]* exercise.timesRight[index]))}>
                        ...
                        ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsLeft[index]* exercise.weightsLeft[index] + exercise.repsRight[index]* exercise.weightsRight[index] ))}>
                        ...
                        ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsLeft[index]* exercise.weightsLeft[index] * exercise.timesLeft[index] + exercise.repsRight[index]* exercise.weightsRight[index] * exercise.timesRight[index]))}>
                ...
                {exercise.repsRight.map((rep, index) => 
                    ...
                    ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsRight[index] + exercise.repsLeft[index]))}>
                    ...
                    ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsRight[index]*exercise.timesRight[index] + exercise.repsLeft[index]*exercise.timesLeft[index]))}>
                    ...
                    ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsRight[index]*exercise.weightsRight[index] + exercise.repsLeft[index]*exercise.weightsLeft[index]))}>
                            <Text style={styles.text} key={index}>{rep} reps with {exercise.weightsRight[index]} kg </Text>
                            <Text style={styles.text}> Rest: {exercise.restTimesRight[index]/60} minutes</Text>
                        </Pressable> 
                    :   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index, (exercise.repsRight[index]*exercise.weightsRight[index] * exercise.timesRight[index] + exercise.repsLeft[index]*exercise.weightsLeft[index] * exercise.timesLeft[index]))}>
        ...
        : <View style={styles.gridContainer}>
            ...
            {exercise.timesLeft.map((time, index) => 
                exercise.weightsLeft[index] === 0 && exercise.restTimesLeft[index] === 0
                ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index,  (exercise.timesLeft[index] + exercise.timesRight[index]))}>
                ...
                : exercise.restTimesLeft[index] === 0
                ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index,  (exercise.timesLeft[index]*exercise.weightsLeft[index] + exercise.timesRight[index]*exercise.weightsRight[index]))}>
        ...
        {exercise.timesRight.map((time, index) => 
            exercise.weightsRight[index] === 0
            ?   <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index,  (exercise.timesRight[index] + exercise.timesLeft[index] ))}>
                    <Text style={styles.text} key={index}>{time} seconds hold with no weight</Text>
                    <Text style={styles.text}> Rest: {exercise.restTimesRight[index]/60} minutes</Text>
                </Pressable>  
            :  <Pressable key={index} style={styles.setContainer} onPress={() => alert("pressed")} onLongPress={() => handleDelete(exercise.exerciseName, false, index,  (exercise.timesRight[index]*exercise.weightsRight[index] + exercise.timesLeft[index]*exercise.weightsLeft[index]))}>
